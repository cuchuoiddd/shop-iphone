                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="required">Vị trí công việc</label>
                                <div class="controls">
                                    <input type="text" name="name" class="form-control name" required data-validation-required-message="Tên vị trí không được bỏ trống">
                                </div>
