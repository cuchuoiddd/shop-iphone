    ...
    <div class="row">
        <div class="col-7">
            <div class="form-group row">
                <label class="col-sm-2 col-form-label required">Loại phản hồi</label>
                <div class="col-sm-10 controls">
                    <select name="type" class="form-control changePH">
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label required">Người được phản hồi</label>
                <div class="col-sm-10 controls">
                    <select name="user_cfrs" class="form-control select2 test" required
                            data-validation-required-message="Người phản hồi không được bỏ trống"
            ...
            <input type="hidden" name="type_cfrs" value="0">
        </div>
        <div class="col-5">
